...
The firewall forward wiring was just as complicated as the wiring on the inside.  There's a 1/2" firewall pass-through for all the wires that need go from inside to out, or visa-versa.  I had thought that'd be plenty big.  Not so.  About half way through wiring the forward side of the firewall, I couldn't pass any more wires through the hole.  The only way to continue was by removing the inner fiberglass sleeve of the pass-through.  That essentially doubled the volume of wires that would fit.  The hole is so packed full, and there's a gel I have yet to apply that will fully seal it, so I'm confident it's an acceptable compromise.     

Based on advise, I installed an over voltage module that'll cut out the alternator should it misbehave.  Of course I wanted to test it.  So I turned power on, flipped the alternator switch, and with two 9V batteries in series (the OV module has a threshold of 16V) I put 18V on the alternator contactor leads, and .... click.  It worked... or maybe not.  I tried again but the alternator contactor wouldn't close.  

I called BandC tech support and he warned that the contactors can weld themselves shut when arcing occurs.  Well the 18V definitely did arc!  It turned out to be faulty wire on the alternator switch.  It was one of those wires I had crimped with the red crimper.  It must have been nearly cut by the terminal such that the arc melted the tiny connection that was being made.  Wire repaired, I called back tech support and asked how to test it without arcing.  He said "Your test is good.  Alternators can throw big arcs.  Use the two 9V batteries again."  So I did.  It arced.  And the circuit breaker popped, exactly as it should.  Baller!    
