...
I completed my first charter flight as a captain, taking a couple from Las Vegas to Page AZ.  Then I did two more flights this week.  It was fun, but left less time to work on the OneX.
...
The only flap control rod fairing solution Sonex offers is an aluminum sheet that requires some tricky bending, and even then it doesn't look terribly good.  I decided to make one out of fiberglass.  
...
Based on the tail fairing I did, with only 3 layers of glass, I used 4 layers on these flap fairings which was probably overkill.  They are VERY sturdy, but weigh quite a bit more than the ABS fairings from sonex. 
